...
<# 
 ...
 .Example
  ...
  Invoke-OMSSavedSearch -SubscriptionID $subscriptionId -ResourceGroupName $ResourceGroupName  -OMSWorkspaceName $OMSWorkspace -Token $Token -QueryName 'SavedQueryName' -Top 50 -Start $StartTime -End $EndTime
